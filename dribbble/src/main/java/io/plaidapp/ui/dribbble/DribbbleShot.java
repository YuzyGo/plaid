    ...
    void bindShot(final boolean postponeEnterTransition) {
        ...
        if (shot.getUser() != null) {
            ...
            if (shot.getCreated_at() != null) {
                shotTimeAgo.setText(DateUtils.getRelativeTimeSpanString(shot.getCreated_at().getTime(),
